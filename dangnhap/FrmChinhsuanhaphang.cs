...
namespace dangnhap
{
    public partial class FrmChinhsuanhaphang : Form
    {
        ...
        public FrmChinhsuanhaphang(string maHoaDonNK)
        {
            InitializeComponent();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            "Values (@maHoaDon, @maNhanVien, @maNhaCungCap, @maSanPham, @soLuong, @donGia, @ghiChu, @thanhTien, @ngayNhap)  ";
                ...
                if (rowsAffectedK > 0)
                {
                    ...
                    this.Hide();
                    new FrmNhaphang(maHoaDonNhapKho).Show();
                }
            }
            catch (Exception ex)
            {
        ...
        {
            this.Close();
            FrmNhaphang frm = new FrmNhaphang(maHoaDonNhapKho);
            frm.Show();
        }
